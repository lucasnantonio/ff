...
const Index = () => (
  <div>
    <Header />
    <NavBar />
    <div style={{ backgroundColor: '#5e5df7' }} className="w-100 pa5 pv6 tl white bg-blue">
      <div className="mw7 flex flex-row-l flex-column center justify-between">
        ...
        <div className="flex flex-column pt4">
          ...
          <div className="flex w-100 justify-center mt4">
            <a target="_blank" href="https://nubank.com.br/pagar/9/cx4IwcOlys">
              <button className="pa3 bn f6 br1 pointer bg-black-30 hover-bg-black-40 white tc mr2">
                R$1,00
              </button>
            </a>
