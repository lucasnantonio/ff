...
function (_Component) {
  ...
  _createClass(Index, [{
    ...
    value: function handleInput(e) {
      ...
      state[e.target.id] = e.target.value; // this.setState(state)
      // calculate retirement age

      var retirementAge = Object(__WEBPACK_IMPORTED_MODULE_4__utils_math__["a" /* calculateRetirementAge */])(this.state);
      this.setState({
...
//# sourceMappingURL=4.76df86655ded4b0e0ea0.hot-update.js.map