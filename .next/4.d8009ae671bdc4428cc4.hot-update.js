...
function (_Component) {
  ...
  _createClass(Index, [{
    key: "handleInput",
    value: function handleInput(target) {
      this.setState({
        retirementAge: Object(__WEBPACK_IMPORTED_MODULE_4__utils_math__["a" /* calculateRetirementAge */])(2000)
      });
    }
  }, {
    key: "render",
...
function calculateRetirementAge(state) {
  return state.myCurrentIncome * state.myCurrentAge;
}

/***/ })

})
//# sourceMappingURL=4.d8009ae671bdc4428cc4.hot-update.js.map